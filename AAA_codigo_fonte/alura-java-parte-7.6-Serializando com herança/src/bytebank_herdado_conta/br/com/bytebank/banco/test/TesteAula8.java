...
public final class TesteAula8 {
	...
	private static void Ex1() {
		 ...
		 * 
		 * 
		 * Perfeito, um objeto que criamos para encapsular uma função ou método. As
		 * classes anônimas facilitam um pouco a criação desses objetos.
		 */
		...
		Comparator<Conta> comparaConta = new Comparator<Conta>() {
